...
## Description
NetPractice is a networking training project from the 42 curriculum designed to teach
the fundamentals of computer networking through practical exercises. The project consists
of multiple interactive levels where the user must configure networks to ensure proper
communication between hosts.

The main objective of NetPractice is to develop a solid understanding of how networks
operate, focusing on addressing, routing, and protocol layers.
